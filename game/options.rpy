...
define config.name = _("Persona 5 Yuri VN Prototype")
...
define build.name = "Persona5YuriVNPrototype"
...
define config.save_directory = "Persona5YuriVNPrototype-1525220617"
